...
Promise.all(initialData)
    .then(([userData, cardsData]) => {
        const initialCards = new Section(userData._id, cardsData[1], cardTemplate, popupDeleteConfirming);
...
const addNewCardToPage = new PopupWithForm(editMestoPopup, {
    formSubmitCallBack(data) {
        ...
        mainApiData
            ...
            .then((cardData) => {
                const initialCards = new Section(currentUserData._id, cardData[1], cardTemplate, popupDeleteConfirming);
